...
eval "az synapse pipeline create --workspace-name $synapse_workspace --name insights_ingest_with_options --file @$this_file_path/pipeline/JSONs/insights_ingest_with_options.json"
eval "az synapse pipeline create --workspace-name $synapse_workspace --name 1_land_insights --file @$this_file_path/pipeline/JSONs/1_land_insights.json"
eval "az synapse pipeline create --workspace-name $synapse_workspace --name 2_ingest_insights --file @$this_file_path/pipeline/JSONs/2_ingest_insights.json"
eval "az synapse pipeline create --workspace-name $synapse_workspace --name 3_refine_insights --file @$this_file_path/pipeline/JSONs/3_refine_insights.json"
eval "az synapse pipeline create --workspace-name $synapse_workspace --name 4_reset_workspace_insights --file @$this_file_path/pipeline/JSONs/4_reset_workspace_insights.json"
eval "az synapse pipeline create --workspace-name $synapse_workspace --name 0_main_insights --file @$this_file_path/pipeline/JSONs/0_main_insights.json"
